...
FSW_HOME=/path/to/fsw600


# PATCH_HOME... location of unzipped BZ-1120384.zip from https://access.redhat.com/jbossnetwork/restricted/softwareDownload.html?softwareId=34613
PATCH_HOME=/path/to/BZ-1120384
...
rm -rf $FSW_HOME/jboss-eap-6.1/bundles/system/layers/base/org/jboss/as/osgi/configadmin/main/jboss-as-osgi-configadmin-7.2.1.Final-redhat-10.jar
...
rm -rf $FSW_HOME/jboss-eap-6.1/modules/system/layers/base/org/hornetq/main/hornetq-journal-2.3.5.Final-redhat-2.jar
rm -rf $FSW_HOME/jboss-eap-6.1/modules/system/layers/base/org/hornetq/ra/main/hornetq-ra-2.3.5.Final-redhat-2.jar
...
rm -rf $FSW_HOME/jboss-eap-6.1/modules/system/layers/base/org/jboss/as/product/eap/dir/META-INF/MANIFEST.MF
...
rm -rf $FSW_HOME/jboss-eap-6.1/modules/system/layers/base/org/kohsuke/rngom/main/rngom-201103-redhat-2.jar
rm -rf $FSW_HOME/jboss-eap-6.1/modules/system/layers/base/org/opensaml/main/module.xml
rm -rf $FSW_HOME/jboss-eap-6.1/modules/system/layers/base/org/opensaml/main/opensaml-2.5.1.redhat-2.jar
rm -rf $FSW_HOME/jboss-eap-6.1/modules/system/layers/base/org/opensaml/main/openws-1.4.2.redhat-4.jar
...
rm -rf $FSW_HOME/jboss-eap-6.1/modules/system/layers/base/org/picketbox/main/picketbox-commons-1.0.0.final-redhat-2.jar
...
rm -rf $FSW_HOME/jboss-eap-6.1/standalone/configuration/dtgov-ui.properties
rm -rf $FSW_HOME/jboss-eap-6.1/standalone/configuration/dtgov.properties
rm -rf $FSW_HOME/jboss-eap-6.1/standalone/configuration/overlord-apps/dtgovui-overlordapp.properties
...
then
   ...
   rm -rf $FSW_HOME/jboss-eap-6.1/standalone/configuration/gadget-server.properties
   rm -rf $FSW_HOME/jboss-eap-6.1/standalone/configuration/overlord-apps/gadget-server-overlordapp.properties
   rm -rf $FSW_HOME/jboss-eap-6.1/standalone/configuration/overlord-rtgov.properties
   rm -rf $FSW_HOME/jboss-eap-6.1/standalone/deployments/overlord-commons-idp.war/WEB-INF/jboss-web.xml
   rm -rf $FSW_HOME/jboss-eap-6.1/standalone/deployments/overlord-commons-idp.war/WEB-INF/picketlink.xml
   rm -rf $FSW_HOME/jboss-eap-6.1/standalone/deployments/overlord-commons-idp.war/WEB-INF/web.xml
   rm -rf $FSW_HOME/jboss-eap-6.1/standalone/deployments/overlord-commons-idp.war/hosted/index.jsp
...
rm -rf $FSW_HOME/jboss-eap-6.1/modules/system/layers/soa/org/switchyard/remote/main/module.xml
rm -rf $FSW_HOME/jboss-eap-6.1/modules/system/layers/soa/org/switchyard/remote/main/switchyard-remote-1.1.1-p5-redhat-1.jar
...
unzip -oq $PATCH_HOME/fsw-6.0_3_2014-base.zip -d $FSW_HOME
unzip -oq $PATCH_HOME/fsw-6.0_3_2014-dtgov.zip -d $FSW_HOME
if [ $RT_TYPE = "server" ]
then
   unzip -oq $PATCH_HOME/fsw-6.0_3_2014-rtgov-server.zip -d $FSW_HOME
fi
if [ $RT_TYPE = "client" ]
then
   unzip -oq $PATCH_HOME/fsw-6.0_3_2014-rtgov-client.zip -d $FSW_HOME
fi   
unzip -oq $PATCH_HOME/fsw-6.0_3_2014-sramp.zip -d $FSW_HOME
unzip -oq $PATCH_HOME/fsw-6.0_3_2014-switchyard.zip -d $FSW_HOME
