...
PATCH_HOME=/home/rick/Tools/JBoss/Patches/FSW/FSW_6.0_4_2014/BZ-1146192
...
unzip -oq $PATCH_HOME/fsw-6.0_4_2014-base.zip -d $FSW_HOME
unzip -oq $PATCH_HOME/fsw-6.0_4_2014-dtgov.zip -d $FSW_HOME
if [ $RT_TYPE = "server" ]
then
   unzip -oq $PATCH_HOME/fsw-6.0_4_2014-rtgov-server.zip -d $FSW_HOME
fi
if [ $RT_TYPE = "client" ]
then
   unzip -oq $PATCH_HOME/fsw-6.0_4_2014-rtgov-client.zip -d $FSW_HOME
fi   
unzip -oq $PATCH_HOME/fsw-6.0_4_2014-sramp.zip -d $FSW_HOME
unzip -oq $PATCH_HOME/fsw-6.0_4_2014-switchyard.zip -d $FSW_HOME
